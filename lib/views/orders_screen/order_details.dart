                              ...
                              children: [
                                ...
                                ListView(
                                  ...
                                  children: List.generate(
                                      controller.orders.length, (index) {
                                    return orderItems(
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                ...
                                orderPlaceDetails(
                                  // d1:DateTime.now(),
                                  d1: intl.DateFormat("h:mma").add_yMd().format(
                                      (productData['order_date'].toDate())),
                                  d2: "${productData['payment_method']}",
                                  title1: "ORDER DATE",
                                  title2: "PAYMENT METHOD",
                                ),
